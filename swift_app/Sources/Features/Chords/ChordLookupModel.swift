...
public enum OfflineChordBuilder {
    ...
    private static let overrides: [String: [[Int]]] = [
        ...
        "D7": [[-1, -1, 0, 2, 1, 2], [-1, 5, 7, 5, 7, 5]],
        "A7": [[-1, 0, 2, 0, 2, 0], [5, 7, 5, 6, 5, 5]],
        "E7": [[0, 2, 0, 1, 0, 0], [0, 7, 6, 7, 5, 0]],
        "B7": [[-1, 2, 1, 2, 0, 2], [7, 9, 7, 8, 7, 7]],
        "Cmaj7": [[-1, 3, 2, 0, 0, 0]],
        "Gmaj7": [[3, 2, 0, 0, 0, 2]],
        "Dmaj7": [[-1, -1, 0, 2, 2, 2]],
        "Amaj7": [[-1, 0, 2, 1, 2, 0]],
